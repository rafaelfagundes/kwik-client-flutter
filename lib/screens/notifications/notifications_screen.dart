  ...
  Widget build(BuildContext context) {
    var items = [
      NotificationItem(
        ...
        createdAt: DateTime(2020, 05, 30, 20, 15, 00),
        isRead: false,
        isNegative: true,
      ...
      NotificationItem(
        ...
        description: '2x Big Mac, 2x Coca-Cola 600ml',
        createdAt: DateTime(2020, 05, 30, 20, 01, 00),
        isRead: false,
      ...
      NotificationItem(
        ValueKey('13e05d4c-34b2-4b8f-bb6e-9e97601083ab'),
      ...
      NotificationItem(
        ValueKey('59fdb571-eafa-49c6-aabb-21bad968a18b'),
      ...
      NotificationItem(
        ValueKey('b70c4659-ab76-4305-8015-f4d8df0729a2'),
      ...
      NotificationItem(
        ValueKey('bf15bcbc-cd6a-4aca-a1e0-9b73bee2cf14'),
