...
/// to also has a [CupertinoNavigationBar] or a [CustomCupertinoSliverNavigationBar]
...
///
/// By default, only one [CupertinoNavigationBar] or [CustomCupertinoSliverNavigationBar]
...
///  * [CustomCupertinoSliverNavigationBar] for a navigation bar to be placed in a
...
class CupertinoNavigationBar extends StatefulWidget
  ...
  /// [CustomCupertinoSliverNavigationBar] instances of the same [Navigator]. With the
...
///
/// The [CustomCupertinoSliverNavigationBar] must be placed in a sliver group such
...
class CustomCupertinoSliverNavigationBar extends StatefulWidget {
  ...
  @override
  _CustomCupertinoSliverNavigationBarState createState() =>
      _CustomCupertinoSliverNavigationBarState();
}

// A state class exists for the nav bar so that the keys of its sub-components
// don't change when rebuilding the nav bar, causing the sub-components to
// lose their own states.
class _CustomCupertinoSliverNavigationBarState
    extends State<CustomCupertinoSliverNavigationBar> {
  _NavigationBarStaticComponentsKeys keys;
...
/// [CustomCupertinoSliverNavigationBar]'s `leading` slot when
/// `automaticallyImplyLeading` is true.
///
